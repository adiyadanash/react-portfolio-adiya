        ...
        <Row style={{ justifyContent: "center", padding: "10px" }}>
          ...
          >
            <h1 style={{ fontSize: "2.1em", paddingBottom: "20px" }}>
              <strong className="purple">Обо мне</strong>
            </h1>
            <Aboutcard />
          </Col>
        ...
        <Row className="skill-tools-wrapper">
          <Col className="skill-wrapper">
            <h3 className="project-heading">
              Профессиональный <strong className="purple">Набор навыков </strong>
            </h3>
          ...
          <Col className="skill-wrapper">
            <h3 className="project-heading">
              <strong className="purple">Инструменты</strong> которые я изучала
            </h3>
